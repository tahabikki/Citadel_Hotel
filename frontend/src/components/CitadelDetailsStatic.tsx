...
const photos = [
  { src: '/uploads/media/hotel/image_007.jpg', alt: 'Citadel Hôtel photo 1' },
  { src: '/uploads/media/hotel/image_011.jpg', alt: 'Citadel Hôtel photo 2' },
  { src: '/uploads/media/hotel/image_032.jpg', alt: 'Citadel Hôtel photo 3' },
  { src: '/uploads/media/hotel/image_084.jpg', alt: 'Citadel Hôtel photo 4' },
];
