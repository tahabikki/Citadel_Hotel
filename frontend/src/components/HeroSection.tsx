...
const slides = [
  {
    type: 'video',
    video: '/uploads/media/hotel/video_01.mp4',
  ...
  {
    type: 'image',
    image: '/uploads/media/hotel/image_064.jpg',
    title: "A Royal Experience",
    subtitle: "Uncompromising Luxury"
  },
  {
    type: 'image',
    image: '/uploads/media/hotel/image_075.jpg',
    title: "Your Sanctuary",
    subtitle: "Refined Comfort Awaits"
  },
  {
    type: 'image',
    image: '/uploads/media/hotel/image_082.jpg',
        ...
        <div className="max-w-4xl">
          {slides[currentSlide].type === 'video' ? (
            <>
              ...
              <p className="text-white/90 text-lg md:text-xl mb-6 font-light max-w-2xl mx-auto">
